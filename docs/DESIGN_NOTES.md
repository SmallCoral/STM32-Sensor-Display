...
主控为 STM32C562CET6。A3 原理图包含 68 个器件；PCB 仍是 A2 的 59 个封装，宽压 DCDC、J101 6P 接口与 J102 尚未同步布局布线，不能直接投板。供电与芯片勘误记录在 [C562 迁移核对](../pcb/ssd/docs/C562_MIGRATION.md)，晶振和封装尺寸记录在 [A2 修订](../pcb/ssd/docs/HSE_FOOTPRINT_A2.md)。
